@php
    $menuItems = [['url' => '/home', 'label' => 'Home', 'icon' => 'fa-home'], ['url' => '/users', 'label' => 'Users', 'icon' => 'fa-user-circle'], ['url' => '/clients', 'label' => 'Clients', 'icon' => 'fa-users']];
    ...
    $settingItems = [['url' => '/cities', 'label' => 'Cities', 'icon' => 'fa-id-badge'], ['url' => '/sub_cities', 'label' => 'SubCities', 'icon' => 'fa-id-badge']];
    $financeItems = [['url' => '/loans', 'label' => 'Loans', 'icon' => 'fa-id-badge'], ['url' => '/balance', 'label' => 'Balance', 'icon' => 'fa-id-badge']];
@endphp
...
<div class="py-4">
    ...
    <ul>
        ...
        @endforeach
        <h2 class="px-6 py-2 text-yellow-600 font-semibold">Finance</h2>
        ...
        @endforeach
        <h2 class="px-6 py-2 text-yellow-600 font-semibold">Settings</h2>
